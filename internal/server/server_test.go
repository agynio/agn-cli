...
func TestServeErrorResponses(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			input:      `{"jsonrpc":"2.0","method":"turn/start","params":{}}`,
			expectedID: "null",
			code:       -32600,
			message:    "invalid request",
		},
		{
			...
			input:      `{"jsonrpc":"2.0","id":1,"method":"turn/unknown","params":{}}`,
			expectedID: "1",
			code:       -32601,
		...
		{
			name:       "invalid params",
			input:      `{"jsonrpc":"2.0","id":1,"method":"turn/start","params":"nope"}`,
			expectedID: "1",
			code:       -32602,
		...
		},
		{
			...
			input:      `{"jsonrpc":"2.0","id":1,"method":"turn/start","params":{"prompt":" "}}`,
			expectedID: "1",
			code:       -32602,
		...
		},
		{
			...
			input:      `{"jsonrpc":"2.0","id":1,"method":"turn/interrupt","params":{"request_id":" "}}`,
			expectedID: "1",
			code:       -32602,
